...
public class HoldBack extends AbstractDynamicCard {
    public static final String ID = DefaultMod.makeID(HoldBack.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("HoldBack.png");
