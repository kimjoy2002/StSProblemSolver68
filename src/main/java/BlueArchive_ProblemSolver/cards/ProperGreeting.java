...
public class ProperGreeting extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(ProperGreeting.class.getSimpleName());
    public static final String IMG = makeCardPath("ProperGreeting.png");
