...
public class MultiBlock extends AbstractDynamicCard {
    public static final String ID = DefaultMod.makeID(MultiBlock.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("MultiBlock.png");
