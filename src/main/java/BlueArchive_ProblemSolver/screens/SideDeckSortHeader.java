...
public class SideDeckSortHeader extends CardLibSortHeader {
    ...
    private SideDeckViewScreen masterDeckView;
    private float scrollY;

    public SideDeckSortHeader(SideDeckViewScreen masterDeckView) {
